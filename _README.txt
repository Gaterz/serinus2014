	...
	I.  Important Notes
		...
		- Do not delete the breakpoint at the beginning of main()
		or else the debugging won't work (your code will
		still be uploaded).
		
		- Sometimes the debugger and programmer need to be
		restarted for the upload process to work again.
		
		- During the upload the "jtag arp_init-reset" is used
		instead of the regular "reset-init".
